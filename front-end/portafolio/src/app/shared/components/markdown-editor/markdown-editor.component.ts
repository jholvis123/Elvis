...
export class MarkdownEditorComponent implements OnInit, OnDestroy {
    ...
    private initToolbarActions(): void {
        this.toolbarActions = [
            { id: 'bold', iconName: 'bold', label: 'Negrita', shortcut: 'Ctrl+B', action: () => this.wrapSelection('**', '**') },
            { id: 'italic', iconName: 'italic', label: 'Cursiva', shortcut: 'Ctrl+I', action: () => this.wrapSelection('*', '*') },
            { id: 'strike', iconName: 'strikethrough', label: 'Tachado', action: () => this.wrapSelection('~~', '~~') },
            { id: 'h1', iconName: 'hashtag', label: 'Encabezado 1', action: () => this.insertAtLineStart('# ') },
            { id: 'h2', iconName: 'hashtag', label: 'Encabezado 2', action: () => this.insertAtLineStart('## ') },
            { id: 'h3', iconName: 'hashtag', label: 'Encabezado 3', action: () => this.insertAtLineStart('### ') },
            ...
            { id: 'code', iconName: 'code-bracket', label: 'Código inline', action: () => this.wrapSelection('`', '`') },
            { id: 'codeblock', iconName: 'code-bracket', label: 'Bloque de código', action: () => this.insertCodeBlock() },
            { id: 'quote', iconName: 'chat-bubble', label: 'Cita', action: () => this.insertAtLineStart('> ') },
            { id: 'ul', iconName: 'list-bullet', label: 'Lista', action: () => this.insertAtLineStart('- ') },
            { id: 'ol', iconName: 'numbered-list', label: 'Lista numerada', action: () => this.insertAtLineStart('1. ') },
            { id: 'check', iconName: 'check-circle', label: 'Checkbox', action: () => this.insertAtLineStart('- [ ] ') },
            { id: 'table', iconName: 'table-cells', label: 'Tabla', action: () => this.insertTable() },
            { id: 'hr', iconName: 'minus', label: 'Línea horizontal', action: () => this.insertText('\n---\n') },
